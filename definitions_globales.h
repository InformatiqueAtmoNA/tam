...
enum TypePolluant {CO,O3,SO2,NO,NO2,NOX,H2S,DIL,TEMP};
...
enum table_equipement {EQUIPEMENT_ID,EQUIPEMENT_ID_MODELE,EQUIPEMENT_NO_SERIE,
                       ...
                       EQUIPEMENT_CONTROLE_FLUX,EQUIPEMENT_PARITE,EQUIPEMENT_PORT,EQUIPEMENT_ADRESSE_IP,EQUIPMENT_PORT_IP,EQUIPEMENT_TYPE_CONNEXION,EQUIPEMENT_TYPE_SOCKET};
...
enum table_test_metro {TEST_METRO_ID,TEST_METRO__TYPE_TEST,TEST_METRO_ID_OPERATEUR,TEST_METRO_ID_SYSTEME_ETALON,TEST_METRO_ID_LIEU,
                     ...
                     TEST_METRO_CRITERE_1,TEST_METRO_CRITERE_2,TEST_METRO_CRITERE_3,TEST_METRO_CRITERE_TEMP_MIN,TEST_METRO_CRITERE_TEMP_MAX,
                     TEST_METRO_CRITERE_VARIATION,TEST_METRO_TEMP_MIN,TEST_METRO_TEMP_MAX,TEST_METRO_TEMP_MOYENNE,
                     TEST_METRO_ID_SONDE,TEST_METRO_PRESENCE_SONDE};
// \enum Colonnes de la table Validation_Test
enum table_validation_test {VALIDATION_TEST_ID,VALIDATION_TEST_ID_TEST,VALIDATION_TEST_OPERATEUR,VALIDATION_TEST_DATE,VALIDATION_TEST_ETAT};
...
enum homewidget_tableview_testrappport{HOMEW_TABVIEW_TEST_ID_TEST,HOMEW_TABVIEW_TEST_MODELE_EQUIPEMENT,HOMEW_TABVIEW_TEST_ID_EQUIP,HOMEW_TABVIEW_TEST_NO_EQUIP,
                                       HOMEW_TABVIEW_TEST_TYPE_TEST,HOMEW_TABVIEW_TEST_DATE,HOMEW_TABVIEW_TEST_VALIDATION};
...
enum model_relationnel_equipement {REL_EQUIPEMENT_ID,REL_EQUIPEMENT_NUM_SERIE,REL_EQUIPEMENT_MODELE,REL_EQUIPEMENT_MARQUE,
                                   REL_EQUIPEMENT_MIN_GAMME,REL_EQUIPEMENT_MAX_GAMME,REL_EQUIPEMENT_OFFSET,REL_EQUIPEMENT_ADRESSE,REL_EQUIPEMENT_PORTSERIE,REL_EQUIPEMENT_IP};
...
enum et_interfaceExecutionTest_tablewidget_Analyseurs
   {ET_TABLEW_ANALYSEURS_ID_EQUIPEMENT,ET_TABLEW_ANALYSEURS_NUM_SERIE,ET_TABLEW_ANALYSEURS_MODELE,
    ...
    ET_TABLEW_ANALYSEURS_OFFSET,ET_TABLEW_ANALYSEURS_ADRESSE,ET_TABLEW_ANALYSEURS_PORTSERIE, ET_TABLEW_ANALYSEURS_IP};
